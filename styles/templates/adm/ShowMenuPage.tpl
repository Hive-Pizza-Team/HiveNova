...
<div id="leftmenu">
	<ul id="menu">
		...
		{if allowedTo('ShowAchievementsPage')}<li><a href="?page=achievements" target="Hauptframe">Achievements</a></li>{/if}
		...
		{if allowedTo('ShowStatUpdatePage')}<li><a href="?page=statsupdate" target="Hauptframe">{$LNG.mu_manual_points_update}</a></li>{/if}
