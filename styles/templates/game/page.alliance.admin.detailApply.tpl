...
{block name="content"}
	...
	<tr>
		<th colspan="4">{$LNG.al_request_from|sprintf:$applyDetail.username} {$apply_time}</th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2">{$applyDetail.name} <a href="game.php?page=galaxy&amp;galaxy={$applyDetail.galaxy}&amp;system={$applyDetail.system}" target="_top">[{$applyDetail.coordinates}]</a></td>
	</tr>
	<tr>
...
<table class="table519">
	...
	<tr>
		<td colspan="4"><textarea name="text" cols="40" rows="10" id="message"></textarea></td>
	</tr>
	<tr>
