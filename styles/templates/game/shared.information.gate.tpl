		...
		{else}
			...
			{if !empty($gateData.gateList)}
				...
				<tr>
					...
					<td style="width:33%;"><input class="jumpgate" name="ship[{$fleetID}]" id="ship{$fleetID}_input" size="7" value="0" type="text" inputmode="numeric"><input onclick="Gate.max({$fleetID});" value="max" type="button"></td>
				</tr>
				{/foreach}
				<tr>
