...
<form id="trader" action="" method="post">
	...
	<tr>
		...
		<td><input name="trade[{$tradeResource}]" id="resource{$tradeResource}" class="trade_input" type="text" inputmode="numeric" placeholder="0" size="30" data-resource="{$tradeResource}"></td>
