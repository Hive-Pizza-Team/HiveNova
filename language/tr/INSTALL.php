...
$LNG['upgrade_required_rev']	= 'Guncelleme programi versiyon  r2579 (2Moons v1. 7) yada ust versiyonlari icin uygulanabilir.';


$LNG['licence_head']			= 'Lisans Kosullari';
$LNG['licence_desc']			= 'Lutfen asagidaki lisans kosullarini iyice okuyunuz.';
$LNG['licence_accept']			= '2Moons kurulumuna devam etmek icin, lisans sartlarini kabul etmeniz gerekmektedir. ';
...
$LNG['req_desc']				= 'Kuruluma baslamadan once 2moons sistemin kurulum icin uygun olup olmadigini test edecek. Sonuclari dikkatlice okumaniz tavsiye edilir ve butun testleri gecmeden bir sonraki adima gecmeyiniz';
$LNG['reg_yes']					= 'Evet';
$LNG['reg_no']					= 'Hayir';
...
$LNG['req_php_need_desc']		= '<strong>Gereken:</strong> — PHP 2moons yazilim dilidir. Bu sebeple, butun fonksiyonlarin tam calisabilmesi icin mevcut PHP versiyonu 5.2.5 yada ustu olmasi gereklidir. ';
...
$LNG['reg_global_desc']			= '2Moons globaller aktif olsun olsun olmasin calisacaktir. Ama, eger mumkunse guvenlik onlemleri bunu inaktif yapmaniz onerilir.';
$LNG['req_ftp_head']			= 'FTP bilgilerini giriniz';
$LNG['req_ftp_desc']			= 'FTP bilgilerinizi giriniz ve 2moons otomatik olarak problemleri duzeltsin. Alternatif olarak, kendiniz yetki verebilirsiniz.';
$LNG['req_ftp_host']			= 'Domain Adi(HostName)';
$LNG['req_ftp_username']		= 'Kullanici Adi';
$LNG['req_ftp_password']		= 'Sifre';
$LNG['req_ftp_dir']				= '2Moons klasoru';
...
$LNG['step3_desc']				= '2Moons veritabani icin mevcut tablolar yaratildi ve varsayilan degerler yuklendi. Bir sonraki isleme gecip kurulumu tamamlamak icin;';
...
$LNG['step6_desc']				= '2Moons sisteminize basari ile kuruldu';
$LNG['step6_info_head']			= '2Moons kullanilmaya hazir!';
$LNG['step6_info_additional']	= 'Asagidaki butona tiklayarak 2moons admin sayfasina yonlendirileceksiniz. 2Moons admin araclarini buradan inceleyebilirsiniz.<br/><br/><strong> &raquo;includes/ENABLE_INSTALL_TOOL&laquo; dosyasini silmeyi unutmayiniz. Eger bu dosya sisteminizde kalirsa baska birisinin oyunu tekrar kurmasina izin vererek kurulumunuzu buyuk riske atarsiniz!</strong>';

$LNG['sql_close_reason']		= 'Oyun su an kapali';
$LNG['sql_welcome']				= '2Moons\'a hosgeldiniz';
