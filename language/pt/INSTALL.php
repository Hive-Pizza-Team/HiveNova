...
$LNG['intro_text']				= 'O 2Moons é um dos melhores projetos de OGame.<br>O 2Moons é a versão mais recente e mais estável do XNova atualmente desenvolvido. 2Moons é notável por sua facilidade de estabilidade, flexibilidade, dinamismo, qualidade e utilização. Nós sempre esperamos ser melhor do que as suas expectativas.<br><br>O sistema de instalação irá guiar-te através da instalação ou atualizar de uma versão anterior para a mais recente. Cada questão, um problema, por favor não hesites em pedir ao nosso desenvolvimento e suporte em caso de duvidas!<br><br>O 2Moons é um projeto em Open Source, lincenciado sob GNU GPL v3. Para que esta seja verificado, por favor clica no link acima onde se refera a "Lincença"<br><br>Antes da instalação pode ser iniciado um pequeno teste para verificar se o seu Plano/Dominio tem todos os requesitos para suportar o 2Moons';
$LNG['intro_upgrade_head']		= '2Moons já instalado?';
$LNG['intro_upgrade_text']		= '<p>Já instalaste o 2Moons e queres fácil atualização?</p><p>Aqui pode atualizar a base de dados antiga com apenas alguns cliques!</p>';
...
$LNG['upgrade_available']		= 'Atualizações disponíveis! A sua base de dados se encontra na revisão %s e poderás atualizar para a revisão %s.<br><br>Escolhe um dos primeiros comandos SQL para iniciar a instalação:';
$LNG['upgrade_notavailable']	= 'A revisão %s é a ultima para a sua base de dados.';
...
$LNG['req_desc']				= 'Antes da instalação prosseguir, o 2Moons realizará alguns testes para verificar se o seu Servidor suporta o 2Moons, de modo garantir que o 2Moons possa ser instalado. É surgerido que leia cuidadosamente os resultados, e não prossiga até todos estes serem verificados.';
$LNG['reg_yes']					= 'Sim';
$LNG['reg_no']					= 'Não';
$LNG['reg_found']				= 'Encontrado';
$LNG['reg_not_found']			= 'Não encontrado';
$LNG['reg_writable']			= 'Gravável';
$LNG['reg_not_writable']		= 'Não gravável';
...
$LNG['req_php_need_desc']		= '<strong>Requerido</strong> — O PHP é a linguagem base de código do 2Moons. Este é requerido a versão PHP 5.2.5 ou superior para que todos os modulos funcionam corretamente';
...
$LNG['reg_global_need']			= 'register_globals desativado?';
$LNG['reg_global_desc']			= '2Moons também irá funcionar, se essa configuração está instalada no seu servidor. No entanto, é recomendado por razões de segurança, desativar o "register_globals" na instalação PHP, se isso é possível.';
$LNG['req_ftp_head']			= 'Inserir informações de FTP';
$LNG['req_ftp_desc']			= 'Escreve as suas informações de FTP de modo 2Moons poder corrigir automaticamente os problemas. Alternativamente, pode também atribuir manualmente permissões de gravação.';
...
$LNG['step1_desc']				= 'Agora que foi determinado que 2Moons pode ser instalado no seu servidor, deverás fornecer algumas informações. Se tu não sabes como executar uma ligação de base de dados, entra em contato com seu provedor de hospedagem primeiro ou com o fórum de 2Moons para ajuda e suporte. Quando tu inserires os dados, verifica se foram introduzidos corretamente';
...
$LNG['step1_mysql_dbpass']		= 'Senha da Base de Dados';
...
$LNG['step4_desc']				= 'O assistente de instalação vai agora criar uma conta de administrador para ti. Escreve o nome de usário, a sua senha e o seu email';
...
$LNG['step4_admin_pass']		= 'Senha de Administrador:';
$LNG['step4_admin_pass_desc']	= 'Escreva uma senha com o comprimento de 6 a 30 caracteres';
...
$LNG['step6_info_additional']	= 'Se clicares no botão abaixo, serás redirecionado para a página de Administração. Ai será um bom partido para começares a explorar as ferramentas de Administrador de 2Moons.<br/><br/><strong>Por favor apaga o &raquo;includes/ENABLE_INSTALL_TOOL&laquo; ou modifica o nome do ficheiro. Com a existência deste ficheiro, pode causar o seu jogo em risco, ao permitir que alguem reescreva a instalação!</strong>';
