...
$LNG['tech'] = array(
 	0 => "Edifícios",
 	1 => "Extrator de Minério",
 	2 => "Refinaria de Silício",
 	3 => "Centrífuga de Urânio",
 	4 => "Central Elétrica Solar",
 	6 => 'Universidade',
	12 => "Central de Urânio",
	14 => "Gigafábrica",
	15 => "Fábrica de Nanites",
	21 => "Estaleiro",
	22 => "Armazém de Metal",
	23 => "Armazém de Silício",
	24 => "Armazém de Urânio",
	...
	132 => 'Pesquisa de Refinamento de Silício',
	133 => 'Pesquisa de Combustível',
...
$LNG['shortDescription'] = array(
	1 => "Utilizado na extração de minério de metal, os extratores de minério são de importância primária para todos os impérios emergentes e estabelecidos.",
	2 => "O silício é o principal recurso utilizado para construir circuitos eletrónicos e formar certos compostos de ligas.",
	3 => "O urânio é usado como combustível para naves espaciais e é colhido no mar profundo. O urânio é uma substância rara e é assim relativamente caro.",
	4 => "As centrais solares absorvem energia da radiação solar. Todas as minas precisam de energia para funcionar.",
	6 => "Reduz o tempo de pesquisa em 8% por nível.",
	12 => "O reator de urânio usa urânio para produzir energia.",
	14 => "As gigafábricas fornecem robôs de construção para auxiliar na construção de edifícios. Cada nível aumenta a velocidade de melhoria dos edifícios.",
	15 => "Esta é a última palavra em tecnologia robótica. Cada nível reduz o tempo de construção de edifícios, naves e defesas.",
	21 => "Todos os tipos de naves e instalações defensivas são construídos no estaleiro planetário.",
	22 => "Fornece armazenamento para o excesso de Metal.",
	23 => "Fornece armazenamento para o excesso de Silício.",
	24 => "Fornece armazenamento para o excesso de Urânio.",
	...
	113 => "A tecnologia de energia trata do conhecimento das fontes de energia, das soluções de armazenamento e das tecnologias que fornecem o que é mais básico: Energia. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.",
	114 => "A tecnologia de hiperespaço fornece o conhecimento para as viagens no hiperespaço utilizadas por muitas naves de guerra. Além disso, cada nível de Tecnologia de Hiperespaço aumenta em 1% a capacidade de carga das naves que exigem esta tecnologia.",
	...
	120 => "O laser (amplificação de luz pela emissão estimulada da radiação) cria um raio intenso de luz, que concentra uma grande quantidade de energia. Além disso, cada nível de Tecnologia Laser aumenta em 1% do valor base o ataque de naves e defesas que exigem esta tecnologia.",
	121 => "Ao acelerar iões é criado um raio letal que causa danos importantes aos objetos que atinge. Além disso, cada nível de Tecnologia de Iões aumenta em 1% do valor base o ataque de naves e defesas que exigem esta tecnologia.",
	122 => "Tecnologia mais avançada que a tecnologia de iões que, em vez de acelerar iões, acelera o plasma com um grande poder energético. Desta forma cria-se um raio que ocasiona danos enormes aos objetos que atinge. Além disso, cada nível de Tecnologia de Plasma aumenta em 1% do valor base o ataque de naves e defesas que exigem esta tecnologia.",
	123 => "Os cientistas dos seus planetas podem comunicar uns com os outros graças a esta rede.",
	...
	131 => 'Aumenta a produção de Metal em 2%.',
	132 => 'Aumenta a produção de Silício em 2%.',
	133 => 'Aumenta a produção de Urânio em 2%.',
	...
	220 => 'Após longos anos de pesquisa, foi possível criar a nave que recolhe Pizzabits pelo universo.',
	...
	603 => 'O engenheiro é especialista na gestão de energia. Em épocas de paz, aumenta a energia de todas as suas colónias. Em caso de ataque, assegura a fonte de energia aos canhões defensivos, evitando uma eventual sobrecarga, reduzindo deste modo as perdas na batalha.',
	604 => 'A Ordem dos cientistas é composta por grandes génios. Pode encontrá-los sempre a discutir questôes que desafiariam a lógica de qualquer pessoa. Nenhuma pessoa normal conseguirá descobrir o código desta ordem, e é a sua presença que inspira todos investigadores no Império a conseguir mais e melhor.',
	...
	611 => 'O comandante faz parte do exército imperial e especializou-se na arte de coordenar as frotas. O seu cérebro e capaz de calcular um grande número de trajetórias.',
	...
	901 => 'O metal é o principal recurso para a construção de edifícios e naves. É o recurso mais barato, mas também o mais necessário. Produzir metal é o menos dispendioso em energia. Quanto maiores forem os extratores, mais fundo escavam na terra.',
	902 => 'O silício é o principal recurso utilizado para construir circuitos eletrónicos e formar certos compostos de ligas.',
	903 => 'O urânio é encontrado nas profundezas. Pertence aos recursos mais raros do Universo. Por ser necessário atingir grandes profundezas para o obter, é o recurso mais caro.',
	911 => 'A energia é necessária para a produção de todos os recursos.',
	921 => 'Os Pizzabits são um recurso muito misterioso. Ninguém sabe realmente de onde vêm. Por vezes surgem do nada. Pode usar Pizzabits para contratar os oficiais mais experientes do universo.',
);
...
$LNG['longDescription'] = array(
	...
	901 => 'O metal é o principal recurso para a construção de edifícios e naves. É o recurso mais barato, mas também o mais necessário. Produzir metal é o menos dispendioso em energia. Quanto maiores forem os extratores, mais fundo escavam na terra.',
	902 => 'O silício é o principal recurso utilizado para construir circuitos eletrónicos e formar certos compostos de ligas. É produzido em minas subterrâneas, onde a matéria-prima é imediatamente transformada em circuitos.',
	903 => 'O urânio é encontrado nas profundezas. Pertence aos recursos mais raros do Universo. Por ser necessário atingir grandes profundezas para o obter, é o recurso mais caro.',
	911 => 'A energia é necessária para a produção de todos os recursos.',
	921 => 'Os Pizzabits são um recurso muito misterioso. Ninguém sabe realmente de onde vêm. Por vezes surgem do nada, e por vezes são encontrados em naves antigas. Há quem diga que não existem, mas já foi provado o contrário. Pode usar Pizzabits para contratar os oficiais mais experientes do universo.',
);
