...
$LNG['uni_info_game_speed']			= 'Скорость игры';
$LNG['uni_info_fleet_speed']		= 'Скорость флотов';
$LNG['uni_info_resources']			= 'Ресурсы';
$LNG['uni_info_galaxy']				= 'Размер галактики';
$LNG['uni_info_galaxy_format']		= '%s галактик × %s систем';
$LNG['uni_info_debris']				= '% в обломки';
$LNG['uni_info_moon_chance']		= 'Макс. шанс луны';
$LNG['uni_info_age']				= 'Возраст';
$LNG['uni_info_age_today']			= 'Открыта сегодня';
$LNG['uni_info_age_one_day']		= '1 день';
$LNG['uni_info_age_days']			= '%s дней';
$LNG['uni_info_fullness']			= 'Вакантность';
$LNG['uni_info_fullness_format']	= '%s / %s свободных систем';
$LNG['uni_info_status_open']		= 'Открыта';
$LNG['uni_info_status_closed']		= 'Закрыта';
$LNG['uni_info_reg_open']			= 'Регистрация открыта';
...
$LNG['buttonRegisterHive']			= 'Зарегистрируйтесь в Hive';
...
$LNG['footerPoweredBy']             = 'Работает на';
...
$LNG['passwordResetMailRequired']	= 'Для сброса пароля нужна настроенная почта. Свяжитесь с администратором.';
