...
$LNG['gl_free_astrotech_required']			= 'Higher astrophysics research is required to colonize this position.';
$LNG['gl_free_colony_cap_reached']			= 'You have reached the maximum number of colonies you can hold.';
$LNG['gl_unknown']							= 'Unknown';
$LNG['gl_free'] 							= 'Free';
$LNG['gl_yes'] 								= 'Yes';
$LNG['gl_no'] 								= 'No';
...
$LNG['fl_objective']						= 'Mission Complete';
...
$LNG['fl_recent_destinations']				= 'Recent destinations';
...
$LNG['fl_expedition_alert_message']		    = 'Danger! The fleet may be lost forever!';
...
$LNG['bd_shipyard_required']				= 'You need to build a Shipyard first. Check the tech tree (Technologies) for requirements.';
$LNG['bd_building_shipyard']				= 'Cannot build ships or defenses until Shipyard upgrade is completed.';
...
$LNG['mg_overview']                         = 'Message Overview';
$LNG['mg_filter_lost']                      = 'With losses';
$LNG['mg_filter_all']                       = 'Show all';
...
$LNG['al_not_exists']					    = 'The Alliance doesn\'t exist';
$LNG['al_newname_specialchar']				= 'The alliance and the tag must be write with alphanumeric characters, word, _, -, .!';
$LNG['al_description_message']		        = 'Text for description of the alliance';
$LNG['al_web_text']							= 'Alliance Web site';
$LNG['al_request']					        = 'Application';
$LNG['al_click_to_send_request']		    = 'Click here to apply to join the alliance';
...
$LNG['al_no_request_pending']				= 'Have %n applications pending';
...
$LNG['al_transfer_alliance']				= 'Transfer Ownership';
...
$LNG['al_discord_webhook_hint']				= 'Paste a Discord webhook URL. Leave blank to keep the current value.';
$LNG['al_discord_webhook_clear']			= 'Remove webhook (disable Discord alerts)';
$LNG['al_discord_webhook_invalid']			= 'That Discord webhook URL is not valid. Other alliance settings were saved.';
...
$LNG['al_legend_disolve_alliance']			= 'Dissolve Alliance';
...
$LNG['al_diplo_ask']                        = 'Pact Proposal';
...
$LNG['al_diplo_info']						= '<p>On this page you can form alliances, non-aggression pacts, and declare wars on other alliances.</p>';
...
//OPTIONS
$LNG['op_error']							= 'Error';
$LNG['op_cant_activate_vacation_mode']		= 'You can\'t activate vacation mode with in-progress activities.';
...
$LNG['op_push_enable']						= 'Enable building, research, and fleet alerts';
...
$LNG['op_public_message_desc']				= 'Shown on your player profile. If this is empty and your Hive account is public (username matches), your Hive profile description is used.';
$LNG['op_public_message_hive']				= 'Your Hive username matches this account. Visitors see this text when you set it; otherwise they see your Hive profile description.';
...
$LNG['cff_mission_acs']						= 'A %s from %s %s %s will reach the %s %s %s. Mission: %s';
$LNG['cff_mission_own_0']					= 'One of your %s from %s %s %s will reach the %s %s %s. Mission: %s';
$LNG['cff_mission_own_1']					= 'One of your %s will return from %s %s %s back to %s %s %s. Mission: %s';
...
$LNG['cff_mission_own_expo_0']				= 'One of your %s from %s %s %s will reach the Position %s. Mission: %s';
$LNG['cff_mission_own_expo_1']				= 'One of your %s will return from the Position %s back to %s %s %s. Mission: %s';
$LNG['cff_mission_own_expo_2']				= 'One of your %s from %s %s %s is on a Expedition to Position %s. Mission: %s';
$LNG['cff_mission_own_recy_0']				= 'One of your %s from %s %s %s will reach the debris %s. Mission: %s';
$LNG['cff_mission_own_recy_1']				= 'One of your %s will return from debris %s back to planet %s %s %s. Mission: %s';
$LNG['cff_mission_target_bad']				= 'A hostile %s from player %s from %s %s %s will reach the %s %s %s. Mission: %s';
...
$LNG['sys_refferal_recruit_title']			= 'Play with friends bonus';
$LNG['sys_refferal_recruit_text']			= 'You reached %s points after joining with a referral invite.<br><br>Your play-with-friends bonus is %s %s';
...
$LNG['fa_no_recyclers']						= 'Sorry, no recyclers available';
