...
$LNG['bd_shipyard_required']				= 'You need to build a Shipyard first. Open the Tech Tree to see the path (Gigafactory 2). If the Shipyard is still locked and Energy Technology is missing, it is listed below.';
