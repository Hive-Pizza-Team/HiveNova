...
$LNG['sys_expe_found_ress_1_1']				= 'Your expedition has discovered a small asteroids cluster from which some resources could be reclaimed. ';
$LNG['sys_expe_found_ress_1_2']				= 'Some easily accessible resource fields were found and raw materials were gained successfully on the remote planetoid.';
$LNG['sys_expe_found_ress_1_3']				= 'Some moderately accessible resource fields were found and raw materials were gained successfully on the remote planetoid.';
...
$LNG['sys_expe_found_dm_1_1']				= 'The expedition has succeeded to capture some Pizzabits.';
$LNG['sys_expe_found_dm_1_2']				= 'Our expedition has discovered a ghost ship, which transported a small amount of Pizzabits. Although we have not been able to find notes on what has happened to the original crew, our technicians, however, managed to get hold of the Pizzabits.';
$LNG['sys_expe_found_dm_1_3']				= 'We met a strange alien on board of a little ship which left a little container for us in exchange for a couple of simple, mathematical calculations with Pizzabits.';
$LNG['sys_expe_found_dm_1_4']				= 'We have found the remains of an alien ship. There was a little container on board with Pizzabits!';
$LNG['sys_expe_found_dm_1_5']				= 'The expedition followed some strange signals and discovered an asteroid, in the core was a small amount of Pizzabits detected. The asteroid was taken on board and the researchers extracted the pizzabits.';
$LNG['sys_expe_found_dm_2_1']				= 'Our expedition has succeeded in a single experiment. You have been able to win pizzabits from a dying star.';
$LNG['sys_expe_found_dm_2_2']				= 'Our expedition reports a strange spectral phenomenon. Among other things this was the reason that pizzabits formed in the energy storages of the ship shields. Our technicians tried to conserve the the phenomenon as long as possible to capture as much as possible pizzabits.';
$LNG['sys_expe_found_dm_2_3']				= 'Our expedition has found an ancient space station, which already floated in space for a long time. The station itself was completely useless, however, still stored in one of its reactors a small set of pizzabits was found.';
$LNG['sys_expe_found_dm_3_1']				= 'Distortion has made it possible for your expedition to get a large amount of pizzabits from a spontaneous hyperspace!';
$LNG['sys_expe_found_dm_3_2']				= 'Our expedition reported a first contact with an unique alien. Apparently an energy creature who was called Legorianer has flown through the ships of the expedition and then decided to help the underdeveloped species out a little, a container with pizzabits was materialized on board of the bridge!';
...
$LNG['sys_expe_time_slow_3']				= 'The new navigation module still has a few bugs in it. The expedition fleet did not only go in the completely wrong direction, the complete uranium was also consumed, because of this the return is delayed a little.';
...
$LNG['sys_expe_nothing_3'] 					= 'A computervirus distorted the navigation shortly after leaving a strange solar system. This made the entire expedition fleet fly in circles for hours. So it can be said that the expedition was not very successful.';
$LNG['sys_expe_nothing_4'] 					= 'A life-form of pure energy has made all expedition members stare at hypnotic symbols on their screens for several days. When most were finally clear in the head again the expedition had to be cancelled due to a uranium shortage.';
...
$LNG['sys_expe_attack_1_1_2'] 				= 'Some primitive barbarians attacked us with spaceships, at least their ships were in horrible conditions. If their weapons posed a serious threat, we would have been forced to reply with our firepower.';
...
$LNG['sys_expe_attack_1_3_3']				= 'We have just received an urgent message from the expedition commander: "They\'re coming at us! They jumped out of hyperspace, fortunately they\'re just pirates, so we have a chance, we\'ll fight!"';
...
$LNG['sys_expe_attack_2_3_3'] 				= 'We had a bit of difficulty pronouncing the dialect of the alien race correctly. Our diplomat accidentally called \'Fire!\' instead of \'Peace!\'';
