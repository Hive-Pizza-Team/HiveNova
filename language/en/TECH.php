...
$LNG['tech'] = array(
  ...
  1 => 'Ore Extractor',
  2 => 'Silicon Refinery',
  3 => 'Uranium Centrifuge',
  4 => 'Solar Power Plant',
  6 => 'University',
 12 => 'Uranium Power Plant',
 14 => 'Gigafactory',
 15 => 'Nanite Factory',
 21 => 'Shipyard',
 22 => 'Metal Storage',
...
132 => 'Silicon Refinement Research',
133 => 'Fuel Research',
...
2 => 'Silicon is the main resource used to build electronic circuits and form certain alloy compounds.',
3 => 'Uranium is used as fuel for spaceships and is harvested in the deep sea. Uranium is a rare substance and is thus relatively expensive.',
...
12 => 'The fusion reactor uses uranium to produce energy.',
14 => 'Gigafactories provide construction robots to aid in the construction of buildings. Each level increases the speed of the upgrade of buildings',
...
23 => 'Provides storage for excess Silicon.',
24 => 'Provides storage for excess Uranium',
...
113 => 'The command of different types of energy is necessary for many new technologies. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.',
...
132 => 'Increases the production of Silicon by 2%',
133 => 'Increases the production of Uranium by 2%',
...
608 => 'The Minister of Defense is a member of the Imperial Army. focus on your job allows you to build a formidable defense in a short period of time.',
...
902 => 'Silicons are the main resource used to build electronic circuits and form certain alloy compounds.',
903 => 'Uranium is found in the deepest sea. It is the most expensive resource and needs the most energy as well.',
...
1 => 'Used in the extraction of metal ore, ore extractors are of primary importance to all emerging and established empires.',
2 => 'Silicons are the main resource used to build electronic circuits and form certain alloy compounds.',
3 => 'Uranium is used as fuel for spaceships and is harvested in the deep sea. Uranium is a rare substance and is thus relatively expensive.',
4 => 'Solar power plants absorb energy from solar radiation. All mines need energy to operate.',
6 => 'Shortens research time each level by 8%.',
12 => 'The fusion reactor uses uranium to produce energy.The efficiency of Uranium power plant raises according to the Energy Technology level as well as its own level. The formula for energy production is:<br>Energy produced = 30 x Uranium Power Plant level x (1.05 + (0.01 * Energy level))^Uranium Power Plant',
14 => 'Gigafactories provide construction robots to aid in the construction of buildings. Each level increases the speed of the upgrade of buildings',
15 => 'This is the ultimate in robotics technology. Each level cuts the construction time for buildings, ships, and defenses',
21 => 'All types of ships and defensive facilities are built in the planetary shipyard',
22 => 'Provides storage for excess Metal.',
...
110 => 'Shielding technology makes the shields on ships and defensive facilities more efficient. Each level of shield technology increases the strength of the shields by 10 % of the base value.',
111 => 'Special alloys improve the armour on ships and defensive structures. The effectiveness of the armour can be increased by 10 % per level.',
113 => 'The command of different types of energy is necessary for many new technologies. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard. That research lets you build ships once those other requirements are met. Additionally, each level of Energy Technology also increases the efficiency of the Uranium Power Plant by increasing the amount of energy produced.',
114 => 'By integrating the 4th and 5th dimensions it is now possible to research a new kind of drive that is more economical and efficient. Additionally, each level of Hyperspace Technology increases the cargo capacity of ships that require this technology by 1%.',
115 => 'The development of this drive makes some ships faster, although each level increases speed by only 10 % of the base value.',
117 => 'The impulse drive is based on the reaction principle. Further development of this drive makes some ships faster, although each level increases speed by only 20 % of the base value.',
118 => 'Hyperspace drive warps space around a ship. The development of this drive makes some ships faster, although each level increases speed by only 30 % of the base value.',
120 => 'Focusing light produces a beam that causes damage when it strikes an object. Additionally, each level of Laser Technology increases the attack power of ships and defenses that require this technology by 1% of the base value.',
121 => 'A deadly beam of accelerated ions. This causes enormous damage when striking an object. Additionally, each level of Ion Technology increases the attack power of ships and defenses that require this technology by 1% of the base value.',
122 => 'A further development of ion technology which accelerates high-energy Plasma, a result of super-heating Ions. This has a devastating effect when striking an object. Additionally, each level of Plasma Technology increases the attack power of ships and defenses that require this technology by 1% of the base value.',
...
202 => 'The small cargo is an agile ship which can quickly transport resources to other planets.<br>After researching Impulse Engine 5, small cargo can use this engine, doubling its base speed.',
203 => 'This cargo ship has a much larger cargo capacity than the small cargo, and is generally faster thanks to an improved drive.',
...
207 => 'Battleships form the backbone of a fleet. Their heavy cannons, high speed, and large cargo holds make them opponents to be taken seriously.',
208 => 'Vacant planets can be colonized with this ship.',
209 => 'The recycler can get raw materials from debris fields.<br>Recycler upgrades to Impulse Engine at level 17 and then to Hyperspace Engine at level 15',
210 => 'Spy probes are small agile drones, which provide data over long distances on fleets and planets.',
211 => 'The bomber was specially designed to destroy a planets defences.<br>After researching Hyperspace Engine 8, Planet Bomber switches to use this engine.',
212 => 'Solar satellites are simple platforms of solar cells that are located in a high stationary orbit. They collect the sunlight and pass it on to the ground station via laser. ',
213 => 'The destroyer is the king of the warships.',
214 => 'The destructive power of the Death Star is second to none and can destroy moons.',
215 => 'The Battle Cruiser is specialized in the interception of hostile fleets.',
...
902 => 'Silicons are the main resource used to build electronic circuits and form certain alloy compounds. It gets produced in mines under the ground, where the raw material instantly is made into circuits.',
903 => 'Uranium is found in the deepest sea. It belongs to the rarest resources in the Universe. Because you have to get to the ground of the sea in order to get Uranium, it is the most expensive resource.',
911 => 'Energy is needed for the production of every resource.',
