...
111 => 'Specjalne stopy metalu zwiększają wytrzymałość opancerzenia. Każdy level zwiększa wytrzymałość opancerzenia o 10% wartości bazowej.',
	113 => 'Znajomość wielu różnych rodzajów energii jest potrzebna dla nowych technologii. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.',
...
124 => 'Moduł astrofizyczny pozwala na kolonizację wiekszej ilości planet. Każdy nieparzysty poziom tej technologi zwiększa maksymalną ilość planet o 1. Astrofizyka zwiększa również ilość ekspedycji.<br><br><li>Poziom 1-3 - 1 ekspedycja</li><li>Poziom 4-8 - 2 ekspedycje</li><li>Poziom 9-15 - 3 ekspedycje</li><li>Poziom 16-24 - 4 ekspedycje</li>',
...
$LNG['longDescription'] = array(
	...
	113 => 'Wszystko co budujesz, poczynając od struktur obronnych, budynków i statków, wymaga energii. Wraz z rozwojem tej technologii możesz używać i produkować bardziej zaawansowane jednostki, wymagające różnych rodzajów energii. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.',
	114 => 'Teoria podróży nadprzestrzennych opiera się na istnieniu wymiarów przyległych. A lot wygląda tak, iż w jednym miejscu statek wchodzi w nadprzestrzeń, a w innym wychodzi, co zajmuje znacznie mniej czasu niż tradycyjny lot. Wraz z rozwojem tej technologii teoria zmiania się w praktykę. Dodatkowo każdy poziom Technologii Nadprzestrzennej zwiększa o 1% ładowność statków, które jej wymagają.',
	...
	120 => 'Lasery są używane w bardzo wielu dziedzinach w twoim imperium, poczynając od komunikacji, gdzie komputery przekształcają wiązkę w czytelny sygnał, po przekazywanie energii na planetę, a kończąc na takim skoncentrowaniu wiązki, by była mordercza. Dodatkowo każdy poziom Technologii Laserowej zwiększa o 1% wartości bazowej atak statków i obrony, które jej wymagają.',
	121 => 'Skoncentrowana wiązka jonów rozpędzona przez akcelelatory wyrządza znaczne szkody przy uderzeniu w cel. Dodatkowo każdy poziom Technologii Jonowej zwiększa o 1% wartości bazowej atak statków i obrony, które jej wymagają.',
	122 => 'Na świecie są 4 stany skupienia: stały, ciecz, gaz i plazma. Technologia plazmowa to zwieńczenie technologii jonowej, gdzie poprzez dalszy rozwój akcelalatorów i ściśnięcie atomów powstaje plazma, która uderzając w cel wyrządza ogromne szkody. Dodatkowo każdy poziom Technologii Plazmowej zwiększa o 1% wartości bazowej atak statków i obrony, które jej wymagają.',
	123 => 'Naukowcy z różnych planet komunikują się ze sobą przez tę sieć. Wraz z rozbudową na kolejny poziom, do sieci zostanie przyłączone dodatkowe laboratorium, przy czym przyłączane będą zawsze laboratoria o najwyższym poziomie.',
