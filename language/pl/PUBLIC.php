...
$LNG['uni_info_game_speed']			= 'Prędkość gry';
$LNG['uni_info_fleet_speed']		= 'Prędkość flot';
$LNG['uni_info_resources']			= 'Zasoby';
$LNG['uni_info_galaxy']				= 'Rozmiar galaktyki';
$LNG['uni_info_galaxy_format']		= '%s galaktyk × %s systemów';
$LNG['uni_info_debris']				= '% na szczątki';
$LNG['uni_info_moon_chance']		= 'Maks. szansa księżyca';
$LNG['uni_info_age']				= 'Wiek';
$LNG['uni_info_age_today']			= 'Otwarte dziś';
$LNG['uni_info_age_one_day']		= '1 dzień';
$LNG['uni_info_age_days']			= '%s dni';
$LNG['uni_info_fullness']			= 'Wakat';
$LNG['uni_info_fullness_format']	= '%s / %s wolnych systemów';
$LNG['uni_info_status_open']		= 'Otwarte';
$LNG['uni_info_status_closed']		= 'Zamknięte';
$LNG['uni_info_reg_open']			= 'Rejestracja otwarta';
...
// Start
$LNG['gameInformations']			= "Gra online strategiczno-ekonomiczna czasu rzeczywistego w kosmosie.\nGraj przeciwko innym graczom.\nNic nie musisz sciągać, grasz w przeglądarce !.\nDarmowa rejestracja";
...
$LNG['registerPasswordDesc']		= 'Hasło musi mieć min %s znaków.';
...
$LNG['registerErrorPasswordLength']	= 'Hasło musi mieć najmniej %s znaków!';
...
$LNG['registerErrorHiveRequiredSeason'] = 'Ten wszechświat wymaga powiązanego konta Hive.';
