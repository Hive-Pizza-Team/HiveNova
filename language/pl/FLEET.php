...
//----------------------------------------------------------------------------//
//SYSTEM
$LNG['sys_attacker_lostunits'] 				= "Agresor przegrał:";
...
$LNG['sys_attack_title']    				= "Doszło do starcia następujących flot: ";
$LNG['sys_attack_round']					= "Runda";
$LNG['sys_attack_attacker_pos'] 			= "Agresor";
$LNG['sys_attack_techologies'] 				= 'Broń: %d %% Pancerz: %d %% Osłona: %d %% ';
$LNG['sys_attack_defender_pos'] 			= "Obrońca";
$LNG['sys_ship_type'] 						= "Typ";
$LNG['sys_br_time'] 						= "Czas";
$LNG['sys_br_result'] 						= "Wynik";
...
$LNG['fleet_attack_1'] 						= "Atakująca flota dokonała ostrzału z siłą:";
$LNG['fleet_attack_2']						= "w obrońcę. Osłony obrońcy pochłonęły:";
$LNG['fleet_defs_1'] 						= "Broniąca się flota oddała ostrzał z siłą:";
$LNG['fleet_defs_2']						= "w agresora. Osłony najeźdźcy pochłonęły:";
$LNG['damage']								= "punktów ostrzału.";
$LNG['sys_attacker_won'] 					= "Agresor wygrał bitwę, jego statki lądują w stolicy, a dowódca przyjmuje upokarzającą przegranego defiladę zwycięskich wojsk.";
...
$LNG['sys_spy_defenses'] 					= "Systemy obronne";
...
$LNG['sys_mess_spy_lostproba'] 				= "Szansa, że sondy szpiegowskie zostały zniszczone: %d%%";
...
$LNG['sys_colo_maxcolo'] 					= "Jedna z twoich flot osiągnęła koordynaty %s. Kolonizacja okazała się niemożliwa, możesz mieć tylko %d planet, przy tak niskiej znajomości astrofizyki. ";
$LNG['sys_colo_allisok'] 					= "Jedna z twoich flot osiągnęła koordynaty %s. Rozpocząłeś kolonizację nowej planety. To kolejny krok do ostatecznego triumfu naszego wspaniałego Imperium.";
$LNG['sys_colo_badpos']  					= "Jedna z twoich flot osiągnęła koordynaty %s. Brak możliwości kolonizacji, twoi kolonizatorzy wracają rozczarowani. ";
$LNG['sys_colo_notfree'] 					= "Jedna z twoich flot osiągnęła koordynaty %s. Po dotarciu na miejsce okazało się, że planeta została wcześniej skolonizowana, przez kogoś innego. Kolonizatorzy wracają do domu kompletnie zdemoralizowani. ";
...
$LNG['sys_expe_found_goods'] 				= "Twoja ekspedycja natrafiła na bogatą planetę! <br>Wydobyła %s %s, %s %s i %s %s. Sprzeciw zacofanych tubylców został brutalnie zdławiony, ku chwale Imperium!";
$LNG['sys_expe_found_ships'] 				= "To niesamowite! Twoja ekspedycja odkryła statki kosmiczne w doskonałym stanie, kto mógł je tutaj porzucić? Miejmy nadzieję, że wykonana sterylizacja będzie wystarczająca i ten dar, nie okaże się naszym przekleństwem...<br>:";
$LNG['sys_expe_back_home'] 					= "Twoja flota powróciła z ekspedycji.";
$LNG['sys_expe_found_ress_1_1']				= 'Twoja ekspedycja trafiła na mały rój asteroid, z niektórych udało się wydobyć cenne surowce.';
$LNG['sys_expe_found_ress_1_2']				= 'Na małej planetoidzie znaleziono łatwo wydobywalne surowce.';
$LNG['sys_expe_found_ress_1_3']				= 'W czasie ekspedycji nasza flota musiała awaryjnie lądować na nieoznaczonej na mapach planecie. Ciężko w to uwierzyć, ale odpady które wyrzuciliśmy tak zachwyciły mieszkające tu istoty, że w podzięce podarowały nam cenne surowce. I właśnie taką niewidzialną rękę rynku lubimy.';
$LNG['sys_expe_found_ress_1_4']				= 'Ekspedycja odkryła radioaktywną planetoidę. Za pomocą statków bezzałogowych wydobyto z niej, co tylko się dało.';
$LNG['sys_expe_found_ress_2_1']				= 'Ekspedycja znalazła starożytny frachtowiec. Ponieważ szanujemy środowisko i chcemy mieć czysty kosmos odzyskaliśmy z tego wraku wszystkie możliwe surowce.';
$LNG['sys_expe_found_ress_2_2']				= 'Twoja ekspedycja trafiła na mały księżyc pełen cennych zasobów. Nie możemy pozwolić, żeby takie dobra się marnowały. Wydobyliśmy wszystko co się dało.';
...
$LNG['sys_expe_lost_fleet_2']				= 'Ekspedycja skorzystała z kilku skrótów oszczędzając sporo czasu, niestety ostatni z nich zaprowadził całą flotę wprost w czarną dziurę. Wszyscy zginęli... a mówili: "gdy się człowiek spieszy to się diabeł cieszy!".';
$LNG['sys_expe_lost_fleet_3']				= 'Awaria na okręcie dowodzenia doprowadziła do reakcji łańcuchowej... Cała ekspedycja zniknęła w spektakularnym wybuchu!';
$LNG['sys_expe_lost_fleet_4']				= 'Flota nie wróciła z nadprzestrzeni. Nikt nie wie, co się stało, ale wygląda na to, że ją utraciliśmy. Naukowcy próbują rozwikłać tę tragiczną zagadkę.';
$LNG['sys_expe_time_fast_1']				= 'Nieprzewidziane sprzężenie zwrotne w agregatach energii sprawiło, iż flota wróciła znacznie szybciej niż się spodziewano. Niestety nie udało się znaleźć niczego cennego.';
$LNG['sys_expe_time_fast_2']				= 'Trochę zbyt śmiały nowy dowódca użył do powrotu niestabilnego tunelu podprzestrzennego. Niestety, zdarzenie to nie przyniosło żadnych nowych rozwiązań, które dałoby się wykorzystać.';
$LNG['sys_expe_time_fast_3']				= 'Ekspedycja nie znalazła niczego ciekawego w badanym sektorze, jednakże flota wpadła w dziwne zawirowania słoneczne, co przyspieszyło jej powrót.';
$LNG['sys_expe_time_slow_1']				= 'Niedoświadczony nawigator doprowadził do błedu podczas skoku - nie dość, że wysłał flotę w rejon gdzie niczego nie ma, to jeszcze na tyle daleko że znacznie wydłuży się powrót flotylli.';
$LNG['sys_expe_time_slow_2']				= 'Do tej pory nie wiadomo dlaczego, ale skok w nadprzestrzeń kompletnie się nie udał. Zamiast wylądować w odległych rejonach układy flota niemal wleciała w słońce! Powrót ekspedycji do domu potrwa dłużej niż pierwotnie zakładano.';
$LNG['sys_expe_time_slow_3']				= 'Podczas testów nowego modułu nawigacji coś poszło nie tak. Flota została wysłana znacznie dalej w nieznaną przestrzeń niż planowano, przez co został zużyty prawie cały zapas paliwa. Flota na najniższych obrotach wraca, ale zajmnie jej to dużo czasu.';
$LNG['sys_expe_time_slow_4']				= 'Wyprawa trafiła na burzę cząstek. Dzieki mechanikom nie doszło do najgorszego, ale burza znacznie wydłuży powrót floty, która tym razem musi obejść się smakiem wracając do bazy z niczym.';
$LNG['sys_expe_time_slow_5']				= 'Statek Dowództwa zderzył się z niezidentyfikowanym obiektem latającym, który wyskoczył z nadprzestrzeni bez żadnego ostrzeżenia. Szkody są tak duże, iż dokonanie niezbędnych napraw wydłuży powrót floty. Nie będzie też możliwości na poszukiwanie czegokolwiek wartościowego.';
$LNG['sys_expe_time_slow_6']				= 'Kosmiczny wiatr z czerwonego olbrzyma zakłócił wejście floty w nadprzestrzeń, a komputery mają duży problem z obliczneniem wyjścia z nadprzestrzeni. Flota wyszła gdzieś na krańcach systemu, gdzie nie ma praktycznie nic. Wracamy z pustymi rękami i do tego dłużej niżbyśmy chcieli.';
$LNG['sys_expe_nothing_1'] 					= 'Wyprawa wraca z niczym, nie licząc zwierzątek z wyglądu przypominających niezdarne kury. Przynajmniej są dość smaczne.';
$LNG['sys_expe_nothing_2'] 					= 'Ekspedycja zrobiła świetne zdjęcia supernowej, ale poza tym nie udało się uchwycić niczego innego. Zdjęcie można zgłaszać na konkurs, wypłata dużej ilości steemu gwarantowana!';
$LNG['sys_expe_nothing_3'] 					= 'Wirus komputerowy spraliżował systemy nawigacyjne wkrótce po opuszczeniu systemu słonecznego. Wyprawę zakończono gdy okazało się, że flota lata w kółko. Winnego hakera należy jak najszybciej odnaleźć i ukarać, suguruję Najjaśniejszemu Imperatorowi, aby jako karę zlecił obcięcie dłoni.';
$LNG['sys_expe_nothing_4'] 					= 'Spotkano nieznaną formę życia w postaci czystej energii. Swoim pięknem i prawdopodobnie wydzielanymi falami pozytywnych emocji zauroczyła całą załogę. Na szczęście pokładowy robot podjął śmiałą, samodzielną decyzję aby zawrócić flotę do domu. Należy się tej puszce medal. Istota, gdy tylko spostrzegła, że flota zmienia kierunek lotu znikła, a załoga wybudziła się z transu wypoczęta i szczęśliwa. Szkoda tylko że bez surowców...';
$LNG['sys_expe_nothing_5'] 					= 'Teraz już wiadomo, że czerowna anomalia klasy 5 nie tylko zakłóca pracę systemów komputerowych, ale również wywołuje halucynacje u ludzi. Nic więcej wyprawa nie wniosła.';
...
$LNG['sys_expe_attack_1_1_5'] 				= 'Nasza flota informuje, że natknęliśmy się na znanego pirtata Moa Tikarr i jej dzikie psy. Żądają kapitulacji, ale nasze Imperium nigdy się nie podadaje! Będziemy walczyć do ostatniej kropli paliwa, naszego lub ich.';
$LNG['sys_expe_attack_1_2_1'] 				= 'Nasza ekspedycja natknęła się na grupę nieznanej grupy pirackiej, niestety nie chcieli się poddać i podporządkować prawu. Bitwa stała się nieunikniona.';
$LNG['sys_expe_attack_1_2_2'] 				= 'Podążając za obiecującymi odczytami trafiliśmy prosto w zasadzkę piratów. Nie poddamy się jednak bez walki, będziesz z nas dumny Imperatorze!';
...
$LNG['sys_expe_attack_2_1_4'] 				= 'Ekspedycja raportuje kontakt z nieznanymi okrętami. Nie udało nam się odszyfrować wiadomości, ale nasze odczyty wskazują, że uzbroili swoje działa...';
$LNG['sys_expe_attack_2_2_1'] 				= 'Napotykaliśmy nieznaną nam rasę obcych, początkowo byli nastawieni pokojowo. Przybyli na nasz okręt dowodzenia, wymieniliśmy się darami i zaprosiliśmy na uroczysty obiad. Niestety najwyraźniej podanie ośmiorniczek kosmitom wyglądającym jak wielkie ośmiornice nie było dobrym pomysłem. Gdy tylko delegacja obcych zobaczyła potrawy, z oburzeniem coś zabulgotali i teleportowali się na swoje okręty. Nie mieliśmy nawet czasu dokończyć jedzenia - kosmici rozpoczęli ostrzał.';
$LNG['sys_expe_attack_2_2_2'] 				= 'Nasza ekspedycja natrafiła na nieznaną rasę. Najprawdopodobniej naruszyliśmy ich teretorium, niestety nie chcieli słuchać wyjaśnień, niezwykle agresywna i wojownicza rasa. Musieliśmy podjąć walkę.';
...
$LNG['sys_irak_def'] 					  	= '%d twoich rakiet zostało zestrzelonych.';
...
$LNG['sys_destruc_echec']       		   	= 'Trzęsienia ziemi przetaczają się po planecie, lecz coś idzie nie tak: Gwiazdy śmierci implodują, rozpadając się na tysiące kawałków. <br>Niestety fala uderzeniowa niszczy kompletnie całą flotę.';
$LNG['sys_destruc_reussi']      		   	= 'Potężne działa Gwiazd śmierci rozniosły księżyc na kawałki. <br>Księżyc został zniszczony.';
$LNG['sys_destruc_null']        		   	= 'Niestety atak zakończył się niepowodzeniem.<br> Księżyc nie został zniszczony.';
...
$LNG['type_mission_2']  					= 'Atak łączony';
