...
$LNG['user_level_2']                        = 'Moderator';
$LNG['user_level_3']                        = 'Operator';
$LNG['user_level_4']                        = 'Administrator';
...
$LNG['gl_free_desc'] 						= 'Niezamieszkana planeta, skolonizuj ją zanim ktoś cię ubiegnie!';
$LNG['gl_free_astrotech_required']			= 'Do skolonizowania tej pozycji wymagany jest wyższy poziom astrofizyki.';
$LNG['gl_free_colony_cap_reached']			= 'Osiągnięto maksymalną liczbę kolonii.';
$LNG['gl_unknown']							= 'Nieznany';
$LNG['gl_free'] 							= 'Free';
$LNG['gl_yes'] 								= 'Tak';
$LNG['gl_no'] 								= 'Nie';
...
$LNG['fl_recent_destinations']				= 'Ostatnie cele';
...
$LNG['fl_modify_sac_name']					= 'ACS-Nazwa';
...
$LNG['bd_shipyard_required']				= 'Musisz najpierw zbudować stocznię. Sprawdź drzewo technologii (Technologie), aby zobaczyć wymagania.';
...
$LNG['in_consumption'] 						= 'Zużycie palia (Deuteru)';
...
$LNG['mg_filter_lost']						= 'Ze stratami';
$LNG['mg_filter_all']						= 'Pokaż wszystkie';
$LNG['mg_send_new']							= 'Utwórz nową';
$LNG['mg_send_to']							= 'Odbiorca';
$LNG['mg_message']							= 'Wiadomość';
$LNG['mg_characters']						= 'Znaków';
$LNG['mg_send']								= 'Wyślij';
$LNG['mg_game_message']						= 'Wiadomość z gry';
...
$LNG['al_description_message'] 				= 'Opis sojusz';
...
$LNG['al_transfer_alliance']				= 'Przekaż władzę nad sojuszem';
...
$LNG['al_has_accepted']						= '</b> zaakceptował twoje podanie .<br>Wiadomość od przywódcy: <br>';
$LNG['al_decline_request']					= 'Odrzuć';
$LNG['al_you_was_declined']					= 'Twoje podanie zostało odrzucone ';
$LNG['al_has_declined']						= '</b> sojusz odrzucił twoje podanie!<br>Wiadomość od przywódcy: <br>';
...
$LNG['al_discord_webhook']					= 'Webhook Discord';
$LNG['al_discord_webhook_hint']				= 'Wklej URL webhooka Discord. Zostaw puste, aby zachować bieżącą wartość.';
$LNG['al_discord_webhook_clear']			= 'Usuń webhook (wyłącz alerty Discord)';
$LNG['al_discord_webhook_invalid']			= 'Ten URL webhooka Discord jest nieprawidłowy. Pozostałe ustawienia sojuszu zostały zapisane.';
...
$LNG['al_manage_request_min_points']        = 'Minimalna liczba punktów';
...
$LNG['al_legend_right_hand']				= 'Zastępca (konieczne, by przekazać władzę w sojuszu)';
$LNG['al_requests']							= 'Podania';
$LNG['al_requests_min_points']              = 'od %s Punktów';
$LNG['al_circular_message']					= 'wiadomość sojusznicza'; // TODO
...
$LNG['al_diplo_level'][4]                   = 'Pakt o nieagresji';
...
$LNG['al_diplo_accept']                    	= 'Otrzymane propozycje paktów';
$LNG['al_diplo_accept_send']                = 'Wysłane propozycje paktów';
...
$LNG['al_diplo_war_mes']                    = 'Sojusz %s wypowiada wojnę %s! Poniżej uzasadnienie i wyjaśnienie przesłane przez %s. <br>Akt wypowiedzenia wojny:<br>%s<br><br>Informacje: Wojna jest ważna po 24h od ogłoszenia! Osłona bash zostanie wyłączona po 24h. <br>Więcej informacji znajdziesz tutaj: <a href="index.php?page=rules" target="_blank">Zasady</a>.';
...
$LNG['al_diplo_exists']						= 'Pakt z sojuszem "%s" już jest podpisany albo jest w trakcie rozpatrywania';
$LNG['al_diplo_info']						= '<p>Na tej stronie możesz zawierać sojusze, pakty o nieagresji i wypowiadać wojny innym aliansom.</p>';
...
$LNG['al_rank_desc']['DIPLOMATIC']			= 'Może prowadzić dyplomację sojuszu';
...
$LNG['bu_request_send']						= 'Wiadomość została wysłana';
...
$LNG['sh_buddy_request']					= 'Zaproś do znajomych';
$LNG['sh_alliance']							= 'Sojusz';
$LNG['sh_planet']							= 'Planeta';
$LNG['sh_coords']							= 'Koordynaty';
$LNG['sh_position']							= 'Ranking';
$LNG['sh_loading']							= '(Ładuję...)';

//----------------------------------------------------------------------------//
//OPTIONS
$LNG['op_error']							= 'Błąd';
$LNG['op_cant_activate_vacation_mode']		= 'Jeśli coś budujesz lub twoje floty są w ruchu, nie będziesz mógł aktywować urlopu';
...
$LNG['op_max_fleets_messages']				= 'Maksymalna ilość wiadomości o wysłanych flotach w widoku galaktyki';
...
$LNG['op_activate_vacation_mode']			= 'Aktywuj urlop. UWAGA urlop trwa minimum 3 dni!';
...
$LNG['op_activate_vacation_mode_descrip']	= 'Tryb urlop podczas długiej nieobecności. By można było aktywować nie możesz nic budować, prowadzić badań, a twoje floty muszą być nieaktywne. Tryb broni przed nowymi aktakami (tzn., że jeśli aktywujesz go podczas wrogiego ataku, to ten atak dojdzie do skutku, ale nie będzie można wysłać następnych). Urlop trwa co najmniej 2 dni. Podczas urlopu produkcja spada do 0!';
...
$LNG['op_public_message_desc']				= 'Wyświetlana na profilu gracza. Jeśli to pole jest puste, a konto Hive jest publiczne (nazwa się zgadza), używany jest opis profilu Hive.';
$LNG['op_public_message_hive']				= 'Twoja nazwa Hive zgadza się z tym kontem. Odwiedzający widzą ten tekst, gdy go ustawisz; w przeciwnym razie opis profilu Hive.';
...
$LNG['sys_refferal_recruit_title']			= 'Bonus za grę ze znajomymi';
$LNG['sys_refferal_recruit_text']			= 'Osiągnąłeś %s punktów po dołączeniu z zaproszenia.<br><br>Twój bonus to %s %s';
...
$LNG['cr_first_round']						= '(Oznacza to że flota została zestrzelona w 1 rundzie) ';
$LNG['cr_type']								= 'Typ';
...
$LNG['fa_vacation_mode_current']			= 'Błąd - masz włączony urlop';
...
$LNG['ma_buster_canyon']					= 'Wyrzutnia Plazmy';
$LNG['ma_small_protection_shield']			= 'Mała osłona planetarna';
$LNG['ma_big_protection_shield']			= 'Duża osłona planetarna';
$LNG['ma_all']								= 'Wszystko';
...
$LNG['pl_range']         					= 'Pozycja w rankingu';
...
<p>W wiadomości powinny znaleźć się takie informacje jak: co robiłeś, kiedy, jakie akcje były aktywne na koncie, czy trwała budowa, lot flot i wszystko inne, co może pomóc!</p>';
...
$LNG['ov_moving_fleets'] = 'Poruszające się floty';
$LNG['gl_trade_space'] = 'Strefa handlowa';
$LNG['fl_transfer_alert_message'] = 'Uwaga! Własność floty zostanie przekazana docelowemu graczowi!';
$LNG['fl_system_places'] = 'Specjalne lokalizacje';
$LNG['fl_no_noresource_exchange'] = 'Brak zasobów w polu wymiany';
$LNG['fl_exchange'] = 'Wymiana';
$LNG['fl_visibility'] = 'Widoczność';
$LNG['fl_visibility_all'] = 'Wszyscy';
$LNG['fl_visibility_alliance'] = 'Sojusznicy i partnerzy handlowi';
$LNG['fl_visibility_no_enemies'] = 'Wszyscy oprócz wrogów';
$LNG['fl_market_type'] = 'Typ rynku';
$LNG['fl_mt_fleet'] = 'Rynek flot';
$LNG['fl_mt_resources'] = 'Rynek zasobów';
$LNG['fl_stronger_techs'] = 'Twój atak/obrona/osłona jest zbyt niski.';
...
$LNG['market_p_total'] = 'Razem';
$LNG['market_p_ratio'] = 'Stosunek';
$LNG['market_p_cost_type'] = 'Typ kosztu';
$LNG['market_p_cost_amount'] = 'Ilość';
$LNG['market_p_end'] = 'Koniec';
$LNG['market_p_from_duration'] = 'Lot z';
$LNG['market_p_to_duration'] = 'Lot do';
$LNG['market_p_submit'] = 'Kup teraz!';
$LNG['market_p_buy'] = 'Kupić';
$LNG['market_ship_as_first'] = 'Typ statku jako pierwszy';
$LNG['market_confirm_are_you_sure'] = 'Czy jesteś pewien?';
$LNG['market_info_header'] = 'Targ';
$LNG['market_info_description'] = 'Lewa strona - oferty sprzedaży | Prawa strona - ilość zakupu<br><br>&bull; Kupione oferty nie mogą być anulowane &bull;<br>&bull; Gracze mogą handlować po każdym kursie wymiany (ratio) &bull;';
$LNG['market_fleet'] = 'Flota';
$LNG['market_p_msg_not_found'] = 'Oferta nie znaleziona.';
$LNG['market_p_msg_more_ships_is_needed'] = 'Potrzeba więcej statków.';
$LNG['market_p_msg_resources_error'] = 'Niewystarczające zasoby.';
$LNG['market_p_msg_sent'] = 'Wysłano %s Lekkich Ładowni, %s Ciężkich Ładowni';
$LNG['market_msg_trade_topic'] = 'Stan handlu';
$LNG['market_msg_trade_from'] = 'Strefa handlowa';
$LNG['market_msg_trade_bought'] = 'Twoja flota leci do %s z %s %s, %s %s, %s %s i kosztuje %s %s';
$LNG['market_msg_trade_sold'] = 'Twoja flota leci do %s z %s %s, %s %s, %s %s.';
$LNG['market_buyable_only_trade_partners'] = 'Tylko partnerzy';
$LNG['market_buyable_no_enemies'] = 'Bez wrogów';
$LNG['market_buyable_no_tech'] = 'Za słaby';
