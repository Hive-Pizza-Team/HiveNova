...
<p>Metal jest jednym z trzech zasobów wydobywalnych w grze. Jest najszybciej i najtaniej produkowany, ale że jest używany do budowy praktycznie wszystkiego na planecie, rozwój tej kopalni jest wskazany! W początkowym etapie gry warto, by poziom kopalni metalu był o kilka leveli wyższy.</p>
...
<h3>Floty:</h3>
<p>Floty możesz wysyłać bezpośrednio z przeglądu galaktyki albo z zakładki flota. Najpierw wybierasz ilość z dostępnych jednostek, potem ustawiasz cel(podajesz koordynaty, które znajdziesz w galaktyce) i ustawiasz szybkość, z jaką ma poruszać się flota. Musisz wybrać również rodzaj akcji jaką ma przeprowadzić flota, poczynając od stacjonuj, a na zbieraniu złomu kończąc.</p>
<h3>Obrona:</h3>
...
Polega na wyszukiwaniu słabych planet w naszym pobliżu (najlepiej graczy nieaktywnych lub mało aktywnych). Wyszukujemy planety, na których nie ma obrony lub jeśli jest to jest na tyle mała, że atak na nią nie przyniesie nam strat lub starty będą minimalne. Innymi słowy musisz atakować to, na czym najwięcej zarobisz, jak najmniej tracąc.</p>
<h3>Polowanie na flotę:</h3>
<p>Dla bardziej zaawansowanych.<br>
Polowanie na wrogie floty.<br>
Najbardziej emocjonująca część gry, czyli polowanie na flotę przeciwnika. Czego potrzebujesz? Sporej dawki szczęścia, a jeszcze więcej czasu, bo do najłatwiejszych zadań to nie należy. Nieoceniona może również okazać się falanga, a jeśli przeciwnik jest silniejszy to wsparcie przyjaciół z sojuszu. Gdy uda Ci się już zniszczyć wrogą flotę, to przychodzi czas na zebranie pola zniszczeń ze złomowania. I tutaj musisz pamiętać o tym, że takie pole zniszczeń może Ci ktoś podkraść. Najważniejszą częścią złomowania jest koordynacja ataku floty i zbierania złomu. Jeśli robisz AKS to bardzo ważną rzeczą jest współpraca graczy.</p>
<h3>Pola zniszczeń:</h3>
<p>Najbardziej wygodna metoda zdobywania zasobów, jak również najbardziej znienawidzona, jeśli dojdzie do kradzieży pola zniszczeń.
...
<p>Najlepszą obroną przed atakiem to nie pozwolenie, by zdobyto informacje o tym, jakie i ile jednostek i zasobów posiadasz! Gdy nie ma Cię przed komputerem wykorzystaj swoją flotę do tego, by załadować zasoby i wysłać na inną swoją planetę z odpowiednio ustawioną prędkością. Ale uwaga! Musisz pamiętać o falandze, co oznacza, że najczęściej najlepszym wyjściem jest odbiór osobisty floty tak, by można ją było zawrócić.</p>
<h3>Najlepszą metodą obrony są odpowiednie fleet save</h3>
<p>Fleet save to kluczowy element w rozwoju twojego imperium, ale wielu graczy o nim nie wie lub zapomina. Istnieje wiele sposobów na to, by zabezpieczyć swoją flotę i zasoby. Jedne są mniej bezpieczne, inne bardziej, ale na pewno warto ich używać. Oto kilka z nich.<br>
</p>
<p>Pierwszą metodą zabezpieczenia floty i zasobów na czas naszej nieobecności w grze jest misja "stacjonuj" z zawróceniem jej, nim doleci do celu. Czyli jeśli wiesz, że nie będzie Cię w grze 4h to wysyłasz całą flotę razem z załadowanymi zasobami z taką prędkością, by doleciała do celu po tych 4 godzinach. Logując się sprawdzasz, czy jej dolot jest bezpieczny - jeśli tak, to możesz jej pozwolić dolecieć do celu, ale jeśli nie, to wtedy klikasz zawróć. Pamiętaj - im więcej czasu masz na zawrócenie floty, tym trudniej będzie ją przechwycić, gdy będzie wracała. Jeśli flotę zawrócisz np. 30 sekund przed osiągnięciem do celu, a osoba która na Ciebie poluje zauważy to na falandze, to wiedząc, ile czasu trwał lot w jedną stronę bardzo łatwo może wyliczyć, o której twoja flota wróci i przechwycić ją w takim momencie, gdy nie będziesz w stanie z nią uciec! Flotę możesz wysłać na planetę, pole zniszczeń czy też księżyc.</p>
...
<h3>Obrona  AKS</h3>
<p>Tak samo jak i atakować, to wspólnie można również się bronić celem minimalizacji strat. Widząc, że leci na ciebie atak, możesz poprosić albo kogoś z listy twoich znajomych lub kogoś z sojuszu, by podesłał Ci flotę. Ważne jednak, byś na planecie, na którą ma zostać wysłana flota, miał zbudowany depozyt sojuszniczy. W innym wypadku nie będzie możliwe wysłanie floty na twoją planetę z misją "zostań"! Jeśli kogoś prosisz o wsparcie należy postarać się o to, by flota sojusznika pojawiła się kilka sekund przed atakiem - w innym wypadku atakujący gracz sprawdzając siły na planecie może stwierdzić, że atak mu się nie opłaca i lepiej wycofać swoje jednostki.</p>
...
<p>Jako księżycową próbę uważa się celowo wysłaną flotę składającą się np. z lekkich myśliwców w ilości 1667 (co daje dokładnie 20% szansy) na silnie bronioną planetę. Dlaczego LM? Dlatego, że są tanie, ale również stosunkowo łatwo je zniszczyć. Oczywiście możesz użyć innych jednostek w innych ilościach i może to wyjść taniej lub drożej. Księżyc nigdy nie będzie większy niż średnica 8944 km.</p>
<h3>Budownictwo</h3>
<p>Budowę na księżycu powinieneś zacząć od zbudowania bazy księżycowej, która da Ci dodatkowe pola pod budowę. Ponieważ pola do zabudowy na księżycu są bardzo cenne i co chwilę trzeba stawiać bazę księżycową nie warto tam budować czegoś, co nie jest absolutnie niezbędne, typu magazyny, stocznia itp.<br>
...
<li><p><b>Falanga</b><br>Falanga służy do szpiegowania aktywnych flot na planetach w jej zasięgu. Każdy poziom zwiększa zasięg falangi. Falanga nie może szpiegować księżyców, tylko planety!</p></li>
