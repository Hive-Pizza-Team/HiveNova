...
$LNG['gl_free_astrotech_required']			= 'Se requiere un mayor nivel de investigación en astrofísica para colonizar esta posición.';
$LNG['gl_free_colony_cap_reached']			= 'Has alcanzado el número máximo de colonias permitidas.';
$LNG['gl_unknown']							= 'Desconocido';
$LNG['gl_free'] 							= 'Libre';
$LNG['gl_yes'] 								= 'Sí';
$LNG['gl_no'] 								= 'No';
...
$LNG['fl_recent_destinations']				= 'Destinos recientes';
...
$LNG['mg_filter_lost']						= 'Con pérdidas';
...
$LNG['al_discord_webhook']					= 'Webhook de Discord';
$LNG['al_discord_webhook_hint']				= 'Pega una URL de webhook de Discord. Déjalo vacío para conservar el valor actual.';
$LNG['al_discord_webhook_clear']			= 'Quitar webhook (desactivar alertas de Discord)';
$LNG['al_discord_webhook_invalid']			= 'Esa URL de webhook de Discord no es válida. El resto de ajustes de la alianza se guardaron.';
...
$LNG['al_diplo_info']						= '<p>En esta página puedes establecer alianzas, pactos de no agresión y declarar la guerra a otras alianzas.</p>';
...
$LNG['op_public_message']					= 'Mensaje público del perfil';
$LNG['op_public_message_desc']				= 'Se muestra en tu perfil de jugador. Si está vacío y tu cuenta Hive es pública (el nombre coincide), se usa la descripción de tu perfil Hive.';
$LNG['op_public_message_hive']				= 'Tu usuario de Hive coincide con esta cuenta. Los visitantes ven este texto si lo escribes; si no, la descripción de tu perfil Hive.';
...
$LNG['cff_mission_npc_raid']				= 'Una %s hostil (%s) alcanzar&aacute; el %s %s %s. Misi&oacute;n: %s';
...
$LNG['sys_refferal_recruit_title']			= 'Bonus por jugar con amigos';
$LNG['sys_refferal_recruit_text']			= 'Has alcanzado %s puntos tras unirte con una invitación.<br><br>Tu bonus es %s %s';
...
$LNG['pl_etc']   							= 'Otros';
$LNG['pl_public_message']					= 'Acerca de';
...
$LNG['gl_trade_space'] = 'Zona de comercio';
$LNG['fl_transfer_alert_message'] = '¡Atención! ¡La propiedad de la flota se transferirá al jugador objetivo!';
$LNG['fl_system_places'] = 'Ubicaciones especiales';
$LNG['fl_no_noresource_exchange'] = 'Sin recursos en el campo de intercambio';
$LNG['fl_exchange'] = 'Intercambiar';
$LNG['fl_visibility'] = 'Visibilidad';
$LNG['fl_visibility_all'] = 'Todos';
$LNG['fl_visibility_alliance'] = 'Aliados y socios comerciales';
$LNG['fl_visibility_no_enemies'] = 'Todos excepto enemigos';
$LNG['fl_market_type'] = 'Tipo de mercado';
$LNG['fl_mt_fleet'] = 'Mercado de flotas';
$LNG['fl_mt_resources'] = 'Mercado de recursos';
$LNG['fl_stronger_techs'] = 'Tu ataque/defensa/escudo es demasiado bajo.';
$LNG['al_invalid_rank_name'] = '¡En el nombre de rango solo se permiten números, letras, espacios, _, -!';
$LNG['al_make_ally_insufficient_points'] = 'No tienes suficientes puntos para crear una Alianza.<br>Se requieren %s puntos, y tienes %s puntos.';
$LNG['sys_back'] = 'Atrás';
$LNG['sys_forward'] = 'Siguiente';
$LNG['market_p_total'] = 'Total';
$LNG['market_p_ratio'] = 'Proporción';
$LNG['market_p_cost_type'] = 'Tipo de costo';
$LNG['market_p_cost_amount'] = 'Cantidad';
$LNG['market_p_end'] = 'Fin';
$LNG['market_p_from_duration'] = 'Vuelo desde';
$LNG['market_p_to_duration'] = 'Vuelo hacia';
$LNG['market_p_submit'] = '¡Comprar ahora!';
$LNG['market_p_buy'] = 'Comprar';
$LNG['market_ship_as_first'] = 'Tipo de nave primero';
$LNG['market_confirm_are_you_sure'] = '¿Estás seguro?';
$LNG['market_info_header'] = 'Mercado';
$LNG['market_info_description'] = 'Lado izquierdo - ofertas de venta | Lado derecho - cantidad de compra<br><br>&bull; Las ofertas compradas no pueden cancelarse &bull;<br>&bull; Los jugadores pueden comerciar a cualquier tipo de cambio (ratio) &bull;';
$LNG['market_fleet'] = 'Flota';
$LNG['market_p_msg_not_found'] = 'Oferta no encontrada.';
$LNG['market_p_msg_more_ships_is_needed'] = 'Se necesitan más naves.';
$LNG['market_p_msg_resources_error'] = 'Recursos insuficientes.';
$LNG['market_p_msg_sent'] = 'Enviados %s Cargueros Ligeros, %s Cargueros Pesados';
$LNG['market_msg_trade_topic'] = 'Estado del comercio';
$LNG['market_msg_trade_from'] = 'Zona de comercio';
$LNG['market_msg_trade_bought'] = 'Tu flota vuela hacia %s con %s %s, %s %s, %s %s y cuesta %s %s';
$LNG['market_msg_trade_sold'] = 'Tu flota vuela hacia %s con %s %s, %s %s, %s %s.';
$LNG['market_buyable_only_trade_partners'] = 'Solo socios';
$LNG['market_buyable_no_enemies'] = 'Sin enemigos';
