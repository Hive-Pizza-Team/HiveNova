...
$LNG['uni_info_debris']				= '% en débris';
$LNG['uni_info_moon_chance']		= 'Chance max. lune';
...
$LNG['uni_info_season_badge']			= 'Éphémère';
$LNG['uni_info_season_number']			= 'Saison %s';
$LNG['uni_info_wipe']					= 'Reset dans';
$LNG['uni_info_wipe_now']				= 'Fermeture en cours';
$LNG['uni_info_wipe_paying']			= 'Paiement des prix';
$LNG['uni_info_wipe_hold']				= 'Reset reporté';
$LNG['uni_info_wipe_starting']			= 'Bientôt';
$LNG['uni_info_entry']					= 'Frais d\'entrée';
...
$LNG['uni_info_season_hive']			= 'Compte Hive requis';
$LNG['uni_info_season_entries_closed']	= 'Entrées fermées';
...
$LNG['registerPasswordDesc']		= 'Le mot de passe doit comporter au moins %s caractéres.';
$LNG['registerPasswordReplay']		= 'Répéter le mot de passe';
$LNG['registerPasswordReplayDesc']	= 'S\'il vous plaît entrez une seconde fois le mot de passe.';
$LNG['registerEmail']				= 'E-mail';
$LNG['registerEmailDesc']			= 'Entrer votre adresse e-Mail s\'il vous plaît!';
$LNG['registerEmailReplay']			= 'Répéter l\'adresse e-Mail';
...
$LNG['footerPoweredBy']				= 'Propulsé par';
...
$LNG['registerErrorPasswordLength']	= 'Le mot de passe doit comporter au moins %s caractères!';
...
$LNG['vertifyNoUserFound']			= 'Requête invalide!';
$LNG['vertifyAdminMessage']			= 'Le login "%s" est actif!';

//lostpassword
$LNG['passwordInfo']				= 'Si vous avez oublié votre mot de passe, vous devez spécifier le login et l\'adresse e-Mail que vous avez renseigné lors de la création de votre compte.';
$LNG['passwordUsername']			= 'login';
$LNG['passwordMail']				= 'E-Mail';
$LNG['passwordCaptcha']				= 'Code de sécurité';
$LNG['passwordSubmit']				= 'Envoyer';
$LNG['passwordErrorUsernameEmpty']	= 'Vous n\'avez pas spécifié le login!';
$LNG['passwordErrorMailEmpty']		= 'Vous avez spécifié une adresse électronique inconnue!';
$LNG['passwordErrorUnknown']		= 'Votre compte n\'a pas pu être trouvé avec les donnéces fournies (veuillez contrôller les champs renseignécs).';
$LNG['passwordErrorOnePerDay']		= 'Le mot de passe de ce compte a été demandé 24 heures avant. Vous ne pouvez donc pas demander de mot de passe pour ce compte pendant les prochaines 24 heures.';
...
$LNG['passwordChangedMailTitle']	= 'Votre nouveau mot de passe: %s';
...
$LNG['news_does_not_exist']			= 'Pas de news disponible!';

//Impressum
$LNG['disclamerLabelAddress']		= 'Adresse du jeu:';
$LNG['disclamerLabelPhone']			= 'Num. de téléphone:';
...
$LNG['registerErrorHiveRequiredSeason'] = 'Cet univers nécessite un compte Hive lié.';
