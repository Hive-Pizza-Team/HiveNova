...
$LNG['shortDescription'] = array(
	...
	113 => 'Die Beherrschung der unterschiedlichen Arten von Energie ist für viele neue Technologien notwendig. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.',
	...
	410 => 'Nach jahrelangen forschen an der Gravitationskraft ist es Forschern gelungen, eine Gravitonenkanone zu entwickeln, die kleine konzentrierte Gravitationsfelder erzeugen kann und sie auf Gegner schießen lässt.',
	...
	602 => 'Der Flottenadmiral ist ein Kriegsveteran und ein gefürchteter Stratege. Sogar wenn die Schlacht aussichtslos scheint, bewahrt er einen kühlen Kopf, um Herr der Lage zu bleiben und den Kontakt zu seinen Flottenkommandeuren aufrecht zu erhalten. Ein Imperator sollte sich den Flottenadmiral leisten um seine Angriffe zu koordinieren und um mehr Flotten in den Kampf ziehen zu lassen.',
...
$LNG['longDescription'] = array(
	...
	113 => 'Die Energietechnik beschäftigt sich mit der Weiterentwicklung der Energieleitsysteme und Energiespeicher, welche für viele neue Technologien benötigt wird. Completing Energy Technology is needed for the Shipyard path, together with the other requirements for the Shipyard.',
	114 => 'Durch die Einbindung der 4. und 5. Dimension ist es nun möglich einen neuartigen Antrieb zu erforschen, welcher sparsamer und leistungsfähiger ist. Zusätzlich erhöht jede Stufe der Hyperraumtechnik die Ladekapazität von Schiffen, die diese Technologie voraussetzen, um 1%.',
	...
	120 => 'Laser (Lichtverstärkung durch induzierte Strahlungsemission) erzeugen einen intensiven, energiereichen Strahl von kohärentem Licht. Diese Geräte finden in allen möglichen Bereichen ihre Bewerbung, von optischen Computern bis hin zu schweren Laserwaffen, die mühelos durch Raumschiffpanzerungen schneiden. Die Lasertechnik bildet einen wichtigen Grundstein für die Erforschung weiterer Waffentechnologien. Voraussetzungen: Forschungslabor (Stufe 1) Energietechnik (Stufe 2). Zusätzlich erhöht jede Stufe der Lasertechnik die Angriffskraft von Schiffen und Verteidigungsanlagen, die diese Technologie voraussetzen, um 1% des Grundwertes.',
	121 => 'Wahrhaft tödlicher Richtstrahl aus beschleunigten Ionen. Die beschleunigten Ionen richten beim Auftreffen auf ein Objekt einen riesigen Schaden an. Zusätzlich erhöht jede Stufe der Ionentechnik die Angriffskraft von Schiffen und Verteidigungsanlagen, die diese Technologie voraussetzen, um 1% des Grundwertes.',
	122 => 'Eine Weiterentwicklung der Ionentechnik, die nicht Ionen beschleunigt, sondern hochenergetisches Plasma. Das hochenergetische Plasma hat eine verheerende Wirkung beim Auftreffen auf ein Objekt. Zusätzlich erhöht jede Stufe der Plasmatechnik die Angriffskraft von Schiffen und Verteidigungsanlagen, die diese Technologie voraussetzen, um 1% des Grundwertes.',
	...
	502 => 'Abfangraketen zerstören angreifende Interplanetarraketen. Jede Boden-Luft-Rakete zerstört eine Interplanetarrakete.',
