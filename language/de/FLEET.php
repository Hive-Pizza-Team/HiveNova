...
$LNG['sys_attack_techologies'] 				= 'Waffen: %d %% Hülle: %d %% Schilde: %d %% ';
$LNG['sys_attack_defender_pos'] 			= 'Verteidiger';
$LNG['sys_ship_type'] 						= 'Type';
$LNG['sys_br_time'] 						= 'Zeit';
$LNG['sys_br_result'] 						= 'Ergebnis';
...
$LNG['sys_mess_spy_lostproba'] 				= 'Chance, dass die Spionagesonden zerstört wurden: %d%%';
...
$LNG['sys_expe_attack_1_3_3'] 				= 'Wir haben gerade eine dringende Nachricht vom Expeditionskommandanten erhalten: "Sie kommen auf uns zu! Sie sind aus dem Hyperraum gesprungen, zum Glück sind es nur Piraten, wir haben also eine Chance, wir werden kämpfen!"';
