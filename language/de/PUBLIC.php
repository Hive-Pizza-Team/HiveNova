...
$LNG['uni_info_game_speed']			= 'Spielgeschwindigkeit';
$LNG['uni_info_fleet_speed']		= 'Flottengeschwindigkeit';
$LNG['uni_info_resources']			= 'Ressourcen';
$LNG['uni_info_galaxy']				= 'Galaxiegröße';
$LNG['uni_info_galaxy_format']		= '%s Galaxien × %s Systeme';
$LNG['uni_info_debris']				= '% Trümmer';
$LNG['uni_info_moon_chance']		= 'Max. Mondchance';
$LNG['uni_info_age']				= 'Alter';
$LNG['uni_info_age_today']			= 'Heute eröffnet';
$LNG['uni_info_age_one_day']		= '1 Tag';
$LNG['uni_info_age_days']			= '%s Tage';
$LNG['uni_info_fullness']			= 'Leerstand';
$LNG['uni_info_fullness_format']	= '%s / %s Systeme frei';
$LNG['uni_info_status_open']		= 'Geöffnet';
$LNG['uni_info_status_closed']		= 'Geschlossen';
$LNG['uni_info_reg_open']			= 'Registrierung offen';
$LNG['uni_info_reg_closed']			= 'Registrierung geschlossen';
$LNG['uni_info_players']			= 'Spieler';
$LNG['uni_info_fleets']				= 'Flotten unterwegs';
$LNG['uni_info_season_badge']			= 'Kurzlebig';
$LNG['uni_info_season_number']			= 'Saison %s';
$LNG['uni_info_wipe']					= 'Reset in';
$LNG['uni_info_wipe_now']				= 'Schließt jetzt';
$LNG['uni_info_wipe_paying']			= 'Preise werden ausgezahlt';
$LNG['uni_info_wipe_hold']				= 'Reset verzögert';
$LNG['uni_info_wipe_starting']			= 'Startet bald';
$LNG['uni_info_entry']					= 'Einstiegsgebühr';
...
$LNG['uni_info_season_hive']			= 'Hive-Konto erforderlich';
$LNG['uni_info_season_entries_closed']	= 'Einstieg geschlossen';

// Button
$LNG['buttonRegister']				= 'Erstelle deinen Account!';
$LNG['buttonRegisterHive']			= 'Registrieren Sie sich bei Hive!';
...
$LNG['hiveAccount']                 = 'Hive-Konto';
$LNG['registerTabEmail']			= 'E-Mail';
$LNG['registerTabHive']				= 'Hive Keychain';
$LNG['registerHiveKeychainInfo']	= 'Melde dich mit deinem Hive-Konto über die Keychain-Browsererweiterung an. Kein Passwort erforderlich — deine Identität wird on-chain verifiziert.';
$LNG['footerPoweredBy']				= 'Unterstützt von';
...
$LNG['registerErrorHiveAccountInvalid']	= 'Sie müssen ein gültiges Hive-Konto angeben!';
$LNG['registerErrorHiveSignature']	= 'Hive-Keychain-Signatur fehlt oder ist ungültig!';
...
$LNG['registerErrorHiveRequiredSeason'] = 'Dieses Universum erfordert ein verknüpftes Hive-Konto.';
