...
class PlayerUtil
{
	...
	{
		return PlanetColonizationRules::maxPlanetCount($USER);
	}

	static public function countOwnedPlanets($USER)
	{
		return PlanetColonizationRules::countOwnedPlanets($USER);
	}

	static public function countOwnedPlanetsFromCache($USER)
	{
		return PlanetColonizationRules::countOwnedPlanetsFromCache($USER);
	}

	static public function hasColonizationCapacity($USER)
	{
		return PlanetColonizationRules::hasColonizationCapacity($USER);
	}

	static public function allowPlanetPosition($position, $USER)
	{
		return PlanetColonizationRules::allowPlanetPosition($position, $USER);
	}
